...
namespace Data.Data
{
    public class HospitalDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new User() {Id = 1, FirstName="Ivanov", Name="Dima", LastName="Dmitrovich", Birthday=new DateTime(1985,06,15), PhoneNumber="0970251515", City="Rivne", Email="dim@ukr.net", Password="1234" }
            });
        }
